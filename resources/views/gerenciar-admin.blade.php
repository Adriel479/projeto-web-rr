                    ...
                    if(isset($usuario)) {
                        foreach($usuario as $item) {
                            echo "<tr>";
                                ...
                                echo "<td><form action='/tipo-usuario' method='post'><input type='hidden' name='_token' value='" . csrf_token() . "'/><input type='text' hidden name='id_usuario' value='" . $item['id_usuario'] .  "'/> <input type='hidden' name='tipo_usuario' value='".$item['tipo_usuario']."'/> <input type='submit' class='btn btn-primary' value='Permissão'/></form></td>";
                            echo "</tr>";
                        }
                    }
                ?>
